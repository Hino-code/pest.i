...
// System metrics - TODO: Fetch from backend API when endpoint is available
// Currently showing empty state as no backend endpoint exists for system metrics
const systemMetrics: Array<{ time: string; cpu: number; memory: number; network: number; storage: number }> = [];

// Sensor data - TODO: Fetch from backend API when endpoint is available
// Currently showing empty state as no backend endpoint exists for sensor data
...
// System logs - TODO: Fetch from backend API when endpoint is available
// Currently showing empty state as no backend endpoint exists for system logs
...
// Network nodes - TODO: Fetch from backend API when endpoint is available
// Currently showing empty state as no backend endpoint exists for network nodes
...
export function SystemStatus() {
  ...
  // If no sensor data, show 0% or N/A
