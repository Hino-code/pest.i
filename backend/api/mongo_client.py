...
# --- CONFIGURATION ---
# MongoDB Atlas connection for model storage (separate from user database)
# Set MONGODB_MODELS_URI in .env file
URI = os.getenv(
    "MONGODB_MODELS_URI",
    "mongodb+srv://user1:khair12345@cluster0.886rdzt.mongodb.net/forecast_db?retryWrites=true&w=majority"
)
DB_NAME = os.getenv("MONGODB_MODELS_DB_NAME", "models_db")
